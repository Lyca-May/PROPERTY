...
<body>
    <div class="main-sidebar">
        <as ide id="sidebar-wrapper">
            <div class="sidebar-brand">
                <a href="index.html"><small><b>ACCOUNTING DIVISION</b></small></a>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active">
                    <a href="{{url('dash-accounting')}}"><i class="ion ion-speedometer"></i><span>Dashboard</span></a>
                </li>
                ...
                <li>
                    <a href="{{ url ('/all-slc')}}"><i class="ion ion-clipboard"></i><span>View All SLC</span></a>
                </li>
                <li>
