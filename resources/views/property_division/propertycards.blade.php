                                                                ...
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <label class="col-form-label"><b>Property, Plant & Equipment:</b></label>
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <label class="col-form-label"><b>Property Number:</b></label>
                                            ...
                                            $(document).ready(function() {
                                                $('#addRowBtn').click(function(e) {
                                                    ...
                                                    var newRow = '<tr>' +
                                                        ...
                                                        '<td><input type="text" name="issue_office_officer" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" placeholder=""></td>' +
                                                        '<td><input type="text" name="bal_qty" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" readonly></td>' +
