                                                                ...
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="col-md-4">
                                                                                    <label class="col-form-label"><b>Property,
                                                                                            Plant &
                                                                                            Equipment:</b></label>
                                                                                ...
                                                                                <table class="table table-bordered" style="font-size: 10px">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th scope="col" colspan="" style="text-align: center;">
                                                                                            </th>
                                                                                        </tr>
                                                                                        <tr>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <input type="text" name="receipt_qty" id="receipt_qtyy" class="form-control text-line receipt-input" style="padding-top: 4px; padding-bottom: 4px;" value="{{ $prop_cards->receipt_qty }}" placeholder="">
                                                                                                @error('receipt_qty')
                                                                                                <span class="text-danger">{{ $message }}</span>
                                                                                                @enderror
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" name="receipt_unitcost" id="receipt_unitcost" class="form-control text-line receipt-input" style="padding-top: 4px; padding-bottom: 4px;" value="{{ $prop_cards->receipt_unitcost }}" placeholder="">
                                                                                                @error('receipt_unitcost')
                                                                                                <span class="text-danger">{{ $message }}</span>
                                                                                                @enderror
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" name="receipt_totalcost" id="receipt_totalcost" class="form-control text-line receipt-total" style="padding-top: 4px; padding-bottom: 4px;" value="{{ $prop_cards->receipt_totalcost }}" readonly>
                                                                                                @error('receipt_totalcost')
                                                                                                <span class="text-danger">{{ $message }}</span>
                                                                                                @enderror
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" name="issue_qty" id="issue_qty" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" placeholder="" value="">
                                                                                                @error('issue_qty')
                                                                                                <span class="text-danger">{{ $message }}</span>
                                                                                                @enderror
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" name="issue_office_officer" id="issue_office_officer" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" placeholder="" value="">
                                                                                            ...
                                                                                            <div style="text-align: center;">
                                                                                                <td>
                                                                                                    <input type="checkbox" name="issue" id="issue_office_officer1" value="issue">
                                                                                                </td>
                                                                                                <td>
                                                                                                    <input type="checkbox" name="transfer" id="issue_office_officer2" value="tra">
                                                                                                </td>
                                                                                                <td>
                                                                                                    <input type="checkbox" name="disposal" id="issue_office_officer3" value="value3">
                                                                                                </td>
                                                                                            </div>
                                                                                            <td>
                                                                                                <input type="text" name="bal_qty" id="" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" placeholder="" value="">
                                                                                                @error('bal_qty')
                                                                                                <span class="text-danger">{{ $message }}</span>
                                                                                                @enderror
                                                                                            </td>
                                                                                            <td>
                                                                                                <input type="text" name="repair_amount" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" placeholder="" value="">
                                                                                                @error('repair_amount')
                                                                                                <span class="text-danger">{{ $message }}</span>
                                                                                                @enderror
                                                                                            </td>
                                            ...
                                            $(document).ready(function() {
                                                $('#addRowBtn').click(function(e) {
                                                    ...
                                                    var newRow = '<tr>' +
                                                        ...
                                                        '<td> <button id="saveButton" class="btn btn-primary"><i class="fas fa-save"></i></button></td>' +
                                                        '</tr>';
