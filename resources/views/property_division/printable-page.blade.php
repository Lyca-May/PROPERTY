                                            ...
                                            <table class="table table-bordered ">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <input type="date" name="date"
                                                                class="form-control text-line"
                                                                style="padding-top: 4px; padding-bottom: 4px;"
                                                                placeholder="" value="{{ $prop_cards->date }}">
                                                            @error('date')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </td>
                                                        ...
                                                        <td>
                                                            <input type="text" name="receipt_qty"
                                                                id="receipt_qtyy" class="form-control text-line"
                                                                style="padding-top: 4px; padding-bottom: 4px;"
                                                        ...
                                                        <td>
                                                            <input type="text" name="receipt_totalcost"
                                                                ...
                                                                style="padding-top: 4px; padding-bottom: 4px;"
                                                                placeholder=""
                                                                value="{{ $prop_cards->receipt_totalcost }}" readonly>
                                                            @error('receipt_totalcost')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </td>
                                                        <td>
                                                            <input hidden type="text" name="issue_qty"
                                                                id="issue_qty" class="form-control text-line"
                                                                style="padding-top: 4px; padding-bottom: 4px;"
                                                                placeholder="" value="{{ $prop_cards->issue_qty }}">
                                                            @error('issue_qty')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </td>
                                                        <td>
                                                            <input hidden type="text" name="issue_office_officer"
                                                        ...
                                                        <td>
                                                            <input hidden type="text" name="bal_qty"
                                                                id="" class="form-control text-line"
                                                                style="padding-top: 4px; padding-bottom: 4px;"
                                                        ...
                                                        <td>
                                                            <input hidden type="text" name="repair_amount"
                                                                class="form-control text-line"
                                                                style="padding-top: 4px; padding-bottom: 4px;"
                                                                placeholder=""
                                                        ...
                                                        <td>
                                                            <textarea hidden type="text" name="remarks" class="form-control text-line"
                                                                style="padding-top: 4px; padding-bottom: 4px;" placeholder="@error('remarks') {{ $message }} @enderror">{{ $prop_cards->remarks }}</textarea>
                                                            @error('remarks')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                        </td>
                                                    ...
                                                    @foreach ($prop_ext->where('prop_id', $prop_cards->id) as $data)
                                                        <tr>
                                                            <td><input type="date" value="{{ $data->date }}"
                                                                    name="date" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px;" placeholder="">
                                                            </td>
                                                            <td>
                                                                <textarea type="text" name="reference" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px; white-space: pre-wrap;" placeholder="">{{ $data->reference }}</textarea>
                                                            </td>
                                                            <td><input type="hidden" name="receipt_qty"
                                                            ...
                                                            <td><input type="hidden" name="receipt_unitcost"
                                                            ...
                                                            <td><input type="hidden" name="receipt_totalcost"
                                                            ...
                                                            <td>
                                                                <textarea type="text" name="reference" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px; white-space: pre-wrap;" placeholder="">{{ $data->issue_transfer_disposal }}</textarea>
                                                                {{-- <input type="text" name="issue_transfer_disposal"
                                                                    class="form-control text-line"
                                                                    style="padding-top: 4px; padding-bottom: 4px;"
                                                                    placeholder=""
                                                            ...
                                                            <td>
                                                                <textarea type="text" name="reference" class="form-control text-line" style="padding-top: 4px; padding-bottom: 4px; white-space: pre-wrap;" placeholder="">{{ $data->transfer_dropdown }}</textarea>

                                                                {{-- <input type="text" name="transfer_dropdown"
                                                                    value="{{ $data->transfer_dropdown }}"
                                                                    class="form-control text-line"
                                                                    style="padding-top: 4px; padding-bottom: 4px;"
                                                                    placeholder="" readonly> --}}
                                                            </td>
                                                            <td><input type="text" name="office_officer"
                                                            ...
                                                            <td class="bal_qty">
                                                                <input type="text" name="new_bal_qty"
                                                                    id="bal-qty{{ $data->id }}"
                                                            ...
                                                            <td><input type="text" name="bal_amount"
                                                            ...
                                                            <td>
                                                                <textarea type="text" name="remarks" value="{{ $data->remarks }}" class="form-control text-line"
                                                                    style="padding-top: 4px; padding-bottom: 4px;" placeholder="">{{ $data->remarks }}</textarea>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        </tr>
